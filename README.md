...
- The URL to use is https://github.com/DevOpsGH/addressbook.git
...
- Team -> Git -> Clone
- Set repository URL to https://github.com/DevOpsGH/addressbook.git
- Finish
...
- Set the repository URL to https://github.com/DevOpsGH/addressbook.git
